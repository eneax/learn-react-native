...
import { View, Text, ActivityIndicator, TouchableOpacity, StyleSheet, Animated } from 'react-native' // ActivityIndicator is a loading spinner
...
export default class Live extends Component {
  state = {
    coords: '',
    status: 'granted', // permissions granted by the user
    direction: '',
